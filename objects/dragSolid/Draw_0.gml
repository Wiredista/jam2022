...
shader_set_uniform_f(uniform_rotation, 0)
shader_set_uniform_f(uniform_light_origin, 0.39, 0.7)
...
shader_set_uniform_f(uniform_size, 2)
shader_set_uniform_f(uniform_seed, 10)
shader_set_uniform_f(uniform_time, 1)
